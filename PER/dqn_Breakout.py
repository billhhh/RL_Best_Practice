...
average_q = []
save_path = "models/breakout_dqn"
outfile_path = "models/output_breakout_dqn.txt"
total_episodes = 100000
best_reward_decay = 0.9999
save_model_steps = 5000000
warmup_steps = 50000
...
def test():
    ...
    dqn_agent = DDQN(
        ...
        use_cuda=USE_CUDA, epsilon=0.05,
    )

    dqn_agent.load(save_path+"_best.h5")
    test_process(dqn_agent)


def train_process(agent):
        ...
        while True:
            ...
            if done:
                ...
                if episode_reward > best_reward * (best_reward_decay ** (i_episode - best_episode)):
                    ...
                    agent.save(save_path+"_best.h5", i_episode)
            ...
            if total_steps % save_model_steps == 0 and total_steps > 0:
                agent.save(save_path + "_" + str(total_steps) + "iter.h5", i_episode)
...
def train():
    ...
    dqn_agent = DDQN(
        ...
        gamma=0.99, lr_decay_epoch=50000, ddqn=True,
    )

    his_dqn = train_process(dqn_agent)
